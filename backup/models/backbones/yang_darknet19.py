...
Author contributed this version of the pretrained feature extracted from YoloV2, DarkNet19.
He published this code and it can be used to load the weights for DarkNet19.
