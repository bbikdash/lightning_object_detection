"""
@author Jianhua Yang
Code from here: https://github.com/yjh0410/yolov2-yolov3_PyTorch/tree/master/backbone
Author contributed this version of the pretrained feature extracted from YoloV3, DarkNet53.
He published this code and it can be used to load the weights for DarkNet52.
